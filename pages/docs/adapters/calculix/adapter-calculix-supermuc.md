...
Additionally, [SPOOLES](http://www.netlib.org/linalg/spooles/spooles.2.2.html), and [ARPACK](https://en.wikipedia.org/wiki/ARPACK) are required.
...
The paths to the CalculiX CCX, SPOOLES, and ARPACK must be specified.
