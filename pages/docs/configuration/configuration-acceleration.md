...
For details on the numerical methods, please have a look [here](Quasi-Newton-Acceleration-Methods). Feel free to [contact us](https://www.precice.org/resources/#contact) for any questions!